...
data = readCGNS('../output2/output_135.cgns')
data2 = readCGNS('../output2/output_143.cgns')
data3 = readCGNS('../output2/output_145.cgns')
data4 = readCGNS('../output2/output_269.cgns')

# data = readCGNS('../output2/output_92.cgns')
# data2 = readCGNS('../output2/output_93.cgns')
# data3 = readCGNS('../output2/output_98.cgns')
...
plt.quiver(data['x_mirror2'], data['y_mirror2'], 2*data['u2'] - data['u_ghost2'], 2*data['v2'] - data['v_ghost2'], color='orange')
# plt.quiver(data['x2'], data['y2'], data['nx2'], data['ny2'], color='m', scale=20)
# for i in range(len(data['x2'])) :
#     plt.plot(data2['Cx'][i*4:(i+1)*4], data2['Cy'][i*4:(i+1)*4], "x")
# plt.xlim([-0.5, 0.5])
plt.show()
...
plt.semilogy(data2['it'], data2['res0'], label='Res0 debug')
plt.semilogy(data3['it'], data3['res0'], label='Res0 modified')
plt.semilogy(data4['it'][:300], data4['res0'][:300], label='Res0 modified 2')
...
plt.semilogy(data2['time'], data2['res0'], label='Res0 debug')
plt.semilogy(data3['time'], data3['res0'], label='Res0 modified')
plt.semilogy(data4['time'], data4['res0'], label='Res0 modified 2')
plt.xlabel('Time (s)')
plt.ylabel('Residual')
plt.legend()
plt.grid()
