...
for cellsize in cellSizes:
    ...
    mesh12 = G.cartr2((5.,0,0), (size,size,0), (2.0,1.0,0.0), (150.,5.,0.))
    mesh21 = G.cartr2((0,5.,0), (size,size,0), (1.0,2.0,0.0), (5.,150.,0.))
    mesh22 = G.cartr2((5.,5.,0), (size,size,0), (2.0,2.0,0.0), (150.,150.,0.))
    ...
    for refine in [2, 4, 6, 8, 10] :
        ...
        filename = f'cylinder/cartesian_mesh_{cellsize}_refined_{refine}.cgns'
