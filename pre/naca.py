...
for cellsize in cellSizes.keys():
    ...
    mesh11 = G.cartr2((0,0,0), (cellsize,cellsize,0), (1.,1.,0.0), (5.,5.,0.))
    mesh12 = G.cartr2((5.,0,0), (cellsize,cellsize,0), (2.,1.0,0.0), (150.,5.,0.))
    mesh21 = G.cartr2((0,5.,0), (cellsize,cellsize,0), (1.0,2.,0.0), (5.,150.,0.))
    mesh22 = G.cartr2((5.,5.,0), (cellsize,cellsize,0), (2.,2.,0.0), (150.,150.,0.))
